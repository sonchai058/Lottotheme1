...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2021 at 02:33 PM
...
--
-- Table structure for table `tb_lotto_date`
--
...
--
-- Dumping data for table `tb_lotto_date`
--

INSERT INTO `tb_lotto_date` (`id`, `date_closed`, `lotto_type`, `status`) VALUES
(1, '2021-01-17', 1, 1),
(2, '2021-02-01', 1, 1),
(3, '2021-02-16', 1, 1),
(4, '2021-03-01', 1, 1),
...
--
-- Table structure for table `tb_lotto_winner`
--
...
CREATE TABLE `tb_lotto_winner` (
  ...
  `deprive` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Indexes for table `tb_lotto_date`
--
ALTER TABLE `tb_lotto_date`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_lotto_winner`
--
ALTER TABLE `tb_lotto_winner`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tb_lotto_date`
--
ALTER TABLE `tb_lotto_date`
...
--
-- AUTO_INCREMENT for table `tb_lotto_winner`
--
ALTER TABLE `tb_lotto_winner`
