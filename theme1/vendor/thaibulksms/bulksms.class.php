...
class bulksms
{
    ...
    public $username = 'slot678';
    public $password = 'oros.16881688';
    ...
    */
    ...
    public function check_credit($username,$password) {
       ...
       $status = $return_data[0];
       $credit = $return_data[1];
    ...
    public function send_message($post_body)
    {
        ...
        $credit =  $this->check_credit($username,$password);
        if ($credit > 0) {
            $ch = curl_init();
    ...
    public function unicode_sms($message, $msisdn,$username,$password)
    {
