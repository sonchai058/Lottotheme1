...
<div class="navigation">
        <div class="container">
            <ul>
<li><a href="<?php echo base_url(); ?>"><i class="fas fa-home"></i><p class="font11" style="margin:-5px 0 0 0;">หน้าแรก</p></a></li>
                <li><a href="<?php echo base_url('Profile'); ?>"><i class="fas fa-user"></i><p class="font11" style="margin:-5px 0 0 0;">บัญชี</p></a></li>
                <li><a href="<?php echo base_url('Deposit'); ?>"><i class="fas fa-wallet"></i><p class="font11" style="margin:-5px 0 0 0;">เติมเงิน</p></a></li>
                <li><a href="<?php echo base_url('withdrawal'); ?>"><i class="fas fa-usd-circle"></i><p class="font11" style="margin:-5px 0 0 0;">ถอนเงิน</p></a></li>
                <li><a href="<?php echo base_url('transfer-to-game'); ?>"><i class="fas fa-exchange"></i><p class="font11" style="margin:-5px 0 0 0;">โยกเงิน</p></a></li>
            </ul>
        </div>
    </div>
    <!-- End navigation -->
