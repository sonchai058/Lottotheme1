...
<div class="container">
    <div class="white-box box-start" style="padding-bottom: 0;">
        ...
        <div class="row text-center" style="position:relative;">
            ...
            <div class="col-6" style="border-left: 1px solid rgb(0,0,0,.05)">
        ...
        <hr>
        <form action="<?php echo base_url('api/member/transfer/towallet');?>" name="transfer_to_wallet" id="transfer_to_wallet" class="form-horizontal text-center" style="margin-top:30px;">
            <label class="font12 font-weight-bold">ระบุจำนวนเงินที่ต้องการโยก</label>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text">฿</span>
                </div>
                <input type="number" name="transfer_to_wallet_amount" class="form-control form-control-lg" value="0" style="font-size:28px !important;">
