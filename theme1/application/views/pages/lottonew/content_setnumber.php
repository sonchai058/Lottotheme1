...
if($mode=='add'){
?>
<h1 class="text-center txt-theme">สร้างเลขชุด</h1>
<?php }else if($mode=='edit'){?>
<h1 class="text-center txt-theme">แก้ไขเลขชุด</h1>
<?php
}
?>
    <div class="row main_left" style="border: 3px #f3b70c solid;/*background-color:rgba(0,0,0,0.1);*/background-color:#450B08; border-radius: 10px; margin:0 auto; padding: 10px;">
      <div class="col-xs-6 col-sm-6 text-left" style="">
        <a href="<?php echo site_url('lottonew');?>" style="font-size: 16px;font-weight: bold" class="btn txt-theme">< กลับ </a>
      </div>
    </div>
    <br/>
          ...
          <div class="row 2num" style="display:none; margin-left: 0px !important;margin-top:5px;">
            <div class="pad2num_listW" style="display:none; padding-left: 5px;">
              ...
              <ul class="pad2num_list">
                ...
                <li><a onclick="ListClick(this)" data-numlabel="87" data-numtext="2 ตัว" href="javascript:void(0)" class="btn btn-listNum listNum97"><span>97</span></a></li></li>
      ...
      <div class="col-xs-12 col-sm-6" style="padding-bottom: 10px">
        <div class="row">
          <div class="col-xs-12" style="padding-left:20px !important">
              <h4 style="padding: 10px;">$ ชื่อเลขชุด</h4>
              <input style="width:99%; font-size:18px; padding:20px" type="text" class="form-control" id="setname" placeholder="ชื่อเลขชุด" value="<?php echo $histMyNumber[0]['name'];?>">
          </div>
        </div>
        <br/>
        <div class="row" style="border-top: 1px #777 solid;">
              <div class="col-xs-12 col-sm-12">
                <h3 class="text-center txt-theme">รายการทั้งหมด <span id="numItems">0</span> รายการ</h3>
              </div>
        </div>
        <div class="row" style="min-height: 80px;">
          <br/>
          <h4 id="itemSelectedNull" class="text-center"color="#fff">ยังไม่มีรายการแทง</h4>
          ...
          <div class="row wbtn_cleardata" style="width:99%; margin:0 auto; padding: 5px; display:none">
            ...
            <div class="col-xs-12 text-center submit" style="margin-top:5px;">
              <form class="p-3 my-3" id="formSave" class="form-horizontal" method="post" action="">
                ...
                <button id="bt_submit" onclick="if(confirm('ยืนยันข้อมูล?')){save();return false;}else{return false;}" class="btn btn-warning " style="width:100%; color:#B22222;font-size: 16px; font-weight:bold"><i style="color:#B22222" class="fa fa-floppy-o" aria-hidden="true"></i>  บันทึก</button>
              </form>
            </div>
          </div>
