...
<div class="form-sm container"><div class="pt-3"><h3 class="text-primary fs-lg">ขั้นตอนง่าย ๆ ในการเล่น Nikigame</h3></div> <div><span class="text-primary">ขั้นตอนที่ 1</span> <p class="fs-sm">
                กดปุ่ม "เปิดบัญชี" เพื่อรับรหัสเข้าสู่ระบบและรหัสผ่านของคุณในส่วนด้านล่างของหน้านี้ จากนั้นโอนเงินเข้ากระเป๋าเงิน Nikigame
            </p></div> <div><span class="text-primary">ขั้นตอนที่ 2</span> <p class="fs-sm">
                ดาวน์โหลด Nikigame จากลิงค์ดาวน์โหลดด้านล่าง
            ...
            <div>
            <!-- <div class="row pb-3"><div class="col-6 not-link"><button class="btn-block btn btn-secondary">ไม่รองรับ IOS</button></div> <div class="col-6"><a rel="noopener" target="_blank" href="https://www.Nikigame.com/Download?publisher=Nikigame&amp;platform=android" class=""><button class="btn-block btn btn-secondary">ดาวน์โหลด ANDROID</button></a></div></div> 
            <a rel="noopener" target="_blank" href="https://Nikigame.com/m/login" class=""><button class="btn-block btn btn-lg btn-primary">เล่นเลย</button></a>
         -->
         <button class="btn-block btn btn-lg btn-danger"><?php echo $creditagent;?></button>
            <br>
            <button onclick="trans_all_to_niki();" id="trans_all_to_niki"  type="button" class="btn px-3 btn-success btn-lg btn-block">ย้ายเงินเข้าเกม</button>
            <br>
         ...
         <a rel="noopener" target="_blank" href="https://Nikigame.com/m/login" class=""><button class="btn-block btn btn-lg btn-primary">เข้าหน้าเว็บ</button></a>
            <!-- <div class="bg-dark p-3 my-4 row"><div class="col-12"><div> <button onclick="trans_all_to_niki();" id="trans_all_to_niki"  type="button" class="btn px-3 btn-success btn-lg btn-block">ย้ายเงินเข้าเกม</button></div></div></div> -->
            <br>
            <div class="bg-dark row pb-3">
       
            <?php foreach ($gamelist->games as $row): ?> 
                <div style="text-align:center;" class="col-4">
                    <img style="width: auto;max-height: 150px;"  src="<?php echo $row->image_url; ?>"> 
                        <!-- <h6><?php echo $row->game_name ?></h6>  -->
                      <button id="playgame<?php echo trim($row->game_code); ?>" onclick="playgame('<?php echo $row->game_code; ?>');" class=" btn btn-primary">เล่นเลย</button> 
