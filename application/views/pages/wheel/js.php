...
function myResult(e) {
  //e is the result object
    ...
    if(e.userData){
      ...
      $.ajax({
        type: "POST",
        url: site_url+'wheel/save',
        data: 'dataList='+JSON.stringify(e), // serializes the form's elements.
...
function init() {
  ...
  loadJSON(function(response) {
    ...
    var jsonData = {
      ...
      "segmentValuesArray" : [
        {"probability":50, "type": "string", "value": "รับ 1 แต้ม", "win": true, "resultText": "รับฟรี 1 Credit !", "userData": {"score":1}},
        {"probability":2, "type": "string", "value": "รับ 5 แต้ม", "win": true, "resultText": "รับฟรี 5 Credit !", "userData": {"score":5}},
        {"probability":50, "type": "string", "value": "รับ 1 แต้ม", "win": true, "resultText": "รับฟรี 1 Credit !", "userData": {"score":1}},
        {"probability":3, "type": "string", "value": "รับ 4 แต้ม", "win": true, "resultText": "รับฟรี 4 Credit !", "userData": {"score":4}},
        {"probability":50, "type": "string", "value": "รับ 1 แต้ม", "win": true, "resultText": "รับฟรี 1 Credit !", "userData": {"score":1}},
        {"probability":4, "type": "string", "value": "รับ 3 แต้ม", "win": true, "resultText": "รับฟรี 3 Credit !", "userData": {"score":3}},
        {"probability":50, "type": "string", "value": "รับ 1 แต้ม", "win": true, "resultText": "รับฟรี 1 Credit !", "userData": {"score":1}},
        {"probability":5, "type": "string", "value": "รับ 2 แต้ม", "win": true, "resultText": "รับฟรี 2 Credit !", "userData": {"score":2}},
        {"probability":50, "type": "string", "value": "ไม่ได้นะจ้ะ", "win": false, "resultText": "ไม่ได้นะจ้ะ!", "userData": {"score":0}},
        {"probability":1, "type": "string", "value": "รับ 10 แต้ม", "win": true, "resultText": "รับฟรี 10 Credit !", "userData": {"score":10}}
      ],
        ...
        "minSpinDuration":3,
        "gameOverText":"หวังว่าคุณจะสนุกกับ เกมวงล้อ <br/><a href='"+site_url+"wheel'>> เล่นอีกครั้ง<u></u>",
...
var xmlns = "http://www.w3.org/2000/svg",
  ...
  spinVelocityTracker,
  gameResultsArray = [],
  pegSnd = new Audio(base_url+'media/wheel_tick.mp3'),
  spinDestinationArray,
  randomSpins = true,
  spinDirection,// = -1,
